...
class ConsoleWriter:
    ...
    def __post_init__(self) -> None:
        self.table = Table(show_header=False, header_style="cyan")
        self.table.add_column("Item", style="cyan")
        self.table.add_column("Status")
        self.table.add_column("Reason", style="yellow")
    ...
    def write_instrument_status(
        ...
        self.table.add_row(rf"{instrument_name}", is_enabled_value, disable_reason or "")
    ...
    def print_bootstrap_table(self) -> None:
        if self.writer_enabled:
            ...
            self.rich_console.print(self.table)
